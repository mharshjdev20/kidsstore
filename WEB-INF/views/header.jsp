...
<header>
	<div class="container">
				...
				<div class="headnav">
					<ul>
						...
						<c:if test="${not empty loggedInUser}">
							...
							<li><a href="home" style="float: right;">Log Out</a></li>
						</c:if>
		...
		<div class="row">
			<div class="span4">
				<div class="logo">
					<a href="home"><img src="static/img/A place to sell, buy, and auction..jpg" alt=""
			...
			<div class="span8">
				<div class="navbar navbar-static-top">
					<div class="navigation">
						<nav>
							<ul class="nav topnav">
								<li class="dropdown"><a href="home">Home <i
