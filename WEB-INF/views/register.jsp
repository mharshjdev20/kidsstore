			...
			<div class="container">
				<div class="row">
					<div class="span6">
						...
						<form:form action="register.jsp" modelAttribute="user" method="post"
					...
					<div class="span6">
						...
						<div class="flexslider">
							<ul class="slides">
								<li><img src="static/img/works/full/boyclothes.jpg"
									alt="" /></li>
								<li><img src="static/img/works/full/girlclothes.jfif"
									alt="" /></li>
								<li><img src="static/img/works/full/tableclothes.jpg"
									alt="" /></li>
							</ul>
						</div>
						<!-- end flexslider -->
