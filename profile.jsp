...
<!-- Theme skin -->
<link href="static/skins/red.css" rel="stylesheet" />
<!-- boxed bg -->
				...
				<div class="row">
					...
					<div class="span3 text-center">
						  ...
						  <c:if test="${not empty loggedInUser.image}">
							<img
								src="static/img/users/${loggedInUser.userId}/profile/${loggedInUser.image}"
				...
				<div class="control-group">
					...
					<div class="controls">
						<label>Please select:</label> <input type="hidden" name="id"
							value="${loggedInUser.userId}"> <input id="file" type="file"
							id="two" name="file">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label>Please select:</label> <input id="fileInput" type="file"
							...
							type="hidden" name="id" value="${loggedInUser.userId}">
					</div>
				</div>
