	...
	<div id="wrapper">
		...
		<section id="content">
			<div class="container">
				...
				<div class="row">
					<div class="span12">
						<h4>Product List ${msg} ${success}</h4>
							...
							<thead>
								<tr>
									 ...
									 <th><input type="text" id="searchnow"
										placeholder="Search Product by Name ${item.size()}"
										...
										<%-- <td>
											<div class="text-center">
												<c:if test="${not empty item.image}">
													<img
														src="static/img/users/${item.userId}/profile/${item.image}"
                    ...
                    No Image
										...
										<%-- <c:if test="${loggedInUser.role eq 'ADMIN'}">
											...
											<td><a href="update?id=${product.id}">Update</a>
											&nbsp;&nbsp;&nbsp;
											<a href="delete?id=${product.id}"
											onclick="confirmed(); return false;">Delete</a>
											</td>
									</tr>
								</c:forEach>
